...
namespace Renderer {
	namespace OpenGL {
		...
		void GLShader::createShaders() {
			...
			// function will handle file io for the streams and then put them into our vertex code and fragment code
			std::string absVertPath = Utils::Platform::getAbsoluteResourcePath(vertexPath_, "GLRenderer/res/Shaders");
			std::string absFragPath = Utils::Platform::getAbsoluteResourcePath(fragmentPath_, "GLRenderer/res/Shaders");
