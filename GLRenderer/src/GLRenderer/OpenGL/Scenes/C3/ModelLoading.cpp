...
namespace GLRenderer {
    ...
    void ModelLoading::Init() {
      //  auto testTexture = std::make_shared<GLRenderer::GLTexture2D>("res/Textures/container2.png", TextureType::DIFFUSE);
      //  auto testTexture1 = std::make_shared<GLRenderer::GLTexture2D>("res/Textures/container2_specular.png", TextureType::SPECULAR);
      //  testTexture->loadTexture();

      //  testTextures.push_back(testTexture);
      //  testTextures.push_back(testTexture1);

        // Now create the mesh:
        //testMesh_ = std::make_unique<GLMesh>(texNormVertices, testTextures);
      //  testMesh_->Init();
        ...
        glDisable(GL_CULL_FACE); // Temporarily disable backface culling
